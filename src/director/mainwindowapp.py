...
class MainWindowAppFactory(object):
    ...
    def initMainWindow(self, fields):
        ...
        if fields.pythonConsoleWidget:
            pythonConsoleDock = app.addWidgetToDock(
                fields.pythonConsoleWidget.get_widget(), QtCore.Qt.BottomDockWidgetArea, visible=False
            )
        ...
        sceneBrowserDock = app.addWidgetToDock(
            fields.objectModel.getTreeWidget(), QtCore.Qt.LeftDockWidgetArea, visible=True
        )
        propertiesDock = app.addWidgetToDock(
            fields.objectModel.getPropertiesPanel(), QtCore.Qt.LeftDockWidgetArea, visible=True
        )
    ...
    def initUndoRedo(self, fields):
        ...
        return FieldContainer(
            undoDock=undoDock, undoStack=undoStack, undoView=undoView, undoAction=undoAction, redoAction=redoAction
        )
    ...
    def initScreenRecorder(self, fields):
        ...
        screen_recorder = ScreenRecorder(main_window=fields.app.mainWindow, view=fields.view)
