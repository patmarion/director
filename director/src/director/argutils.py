...
def add_standard_args(parser):
    ...
    parser.add_argument("--test-data-dir", type=str, help="testing data directory")

    # Output directory
    parser.add_argument("--test-output-dir", type=str, help="output directory for writing test output")
