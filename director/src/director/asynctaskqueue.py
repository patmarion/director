...
class UserPromptTask(AsyncTask):
    ...
    def showDialog(self):
        ...
        buttons.addButton('Yes', QtWidgets.QDialogButtonBox.AcceptRole)
        buttons.addButton('No', QtWidgets.QDialogButtonBox.RejectRole)
        buttons.accepted.connect(self.d.accept)
        buttons.rejected.connect(self.d.reject)

        l = QtWidgets.QVBoxLayout(self.d)
        l.addWidget(QtWidgets.QLabel(self.message))
        l.addWidget(buttons)

        self.d.setAttribute(QtCore.Qt.WA_QuitOnClose, False)
        self.d.show()
        self.d.raise_()
        self.d.accepted.connect(self.onYes)
        self.d.rejected.connect(self.onNo)
